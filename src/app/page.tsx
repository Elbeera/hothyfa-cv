        ...
        <div className="max-w-3xl space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-xl border border-slate-300 px-5 py-3 text-sm font-medium text-slate-900 transition hover:border-slate-900 hover:bg-slate-50"
            >
              Email Me
            </a>
          </div>
